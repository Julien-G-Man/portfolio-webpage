          ...
          <div className="max-w-2xl space-y-8">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/10 backdrop-blur rounded-full border border-white/20">
                <span className="text-xs font-medium text-yellow-300">Available for opportunities</span>
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-6 text-sm">
              <div className="flex items-start gap-3">
                <div className="w-1 h-6 bg-yellow-300 rounded-full flex-shrink-0 mt-1" />
                <div>
            ...
            <div className="pt-4">
              <button
                ...
                className="inline-flex items-center gap-2 px-6 py-3 bg-yellow-300 text-black font-medium rounded-lg hover:bg-yellow-400 transition-colors group"
              >
                View My Work
